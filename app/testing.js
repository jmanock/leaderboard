...
app.constant('fbURL', 'https://reditclone.firebaseio.com');
...
app.controller('MainController', function ($scope, $firebase, Posts) {
    ...
    $scope.deletePost = function (post) {
        ...
        var postForDeletion = new Firebase('https://reditclone.firebaseio.com/' + post.$id);
    ...
    $scope.addComment = function (post, comment) {
        if ($scope.authData) {
            var ref = new Firebase('https://reditclone.firebaseio.com/' + post.$id + '/comments');
    ...
    $scope.removeComment = function(post, comment) {
        var commentForDeletion = new Firebase('https://reditclone.firebaseio.com/' + post.$id + '/comments/' + comment.$id);
